...
const SSN = ({ register, errorMessage, validateForm, ssn1, ssn2, editPage }: Props) => {
      ...
      <div className="flex items-center space-x-4">
        <input
          {...register("ssn1", {
            ...
            onChange: (e) => validateForm && validateForm.inputValid(e, "ssn1", NUMBER),
          })}
        ...
        <input
          {...register("ssn2", {
            ...
            onChange: (e) => validateForm && validateForm.inputValid(e, "ssn2", NUMBER),
          })}
          type="text"
          maxLength={7}
